<template>
  <div class="alert-box" v-if="showAlert">
    ...
    />
    <div v-if="showError" class="error">Некорректный URL</div>
    <div class="button-box">
      <button class="button width" @click="add">Добавить</button>
...
export default {
  ...
  methods: {
    ...
    add() {
      ...
      if (this.URL.match(regexURL)) {
        this.$options.alertController.resolve(this.URL);
        this.URL = "";
